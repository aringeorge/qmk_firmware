...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] =
{
    [_BASE] = LAYOUT(
        ...
        KC_NO,      KC_NO,      KC_GRV,      KC_1,       KC_2,       KC_3,       KC_4,       KC_5,       KC_6,       KC_7,       KC_8,       KC_9,       KC_0,        KC_MINS,     KC_EQL,      KC_BSPC,     KC_HOME,     KC_END,
    ...
    [_GAME] = LAYOUT(
        KC_1,           KC_2,           KC_3,           KC_4,           KC_5,           KC_6,           LCTL(KC_1),     LCTL(KC_2),      LCTL(KC_3),    KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,
        KC_7,           KC_8,           KC_9,           KC_0,           KC_MINS,        KC_EQL,         LCTL(KC_4),     LCTL(KC_5),      LCTL(KC_6),    KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,
        LSFT(KC_1),     LSFT(KC_2),     LSFT(KC_3),     LSFT(KC_4),     LSFT(KC_5),     LSFT(KC_6),     LCTL(KC_7),     LCTL(KC_8),      LCTL(KC_9),    KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,
