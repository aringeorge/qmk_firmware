...
{
    [_QWERTY] = LAYOUT(
        MO(_PROG),      KC_NO,      KC_ESC,      KC_F1,      KC_F2,      KC_F3,      KC_F4,      KC_F5,      KC_F6,         KC_F7,      KC_F8,      KC_F9,      KC_F10,      KC_F11,      KC_F12,      KC_DEL,      KC_F24,      MO(_PROG),
        ...
        TO(_GAME),      KC_NO,      KC_NO,       KC_LCTL,    KC_LALT,    KC_LGUI,    KC_APP,     KC_NO,      KC_SPC,        KC_SPC,     KC_NO,      KC_APP,     KC_RGUI,     KC_RALT,     KC_RCTL,     KC_LEFT,     KC_DOWN,     KC_RGHT
    ),
    [_COLEMAK] = LAYOUT(
        MO(_PROG),      KC_NO,      KC_ESC,      KC_F1,      KC_F2,      KC_F3,      KC_F4,      KC_F5,      KC_F6,         KC_F7,      KC_F8,      KC_F9,      KC_F10,      KC_F11,      KC_F12,      KC_DEL,      KC_F24,      MO(_PROG),
        TO(_QWERTY),    KC_NO,      KC_GRV,      KC_1,       KC_2,       KC_3,       KC_4,       KC_5,       KC_6,          KC_7,       KC_8,       KC_9,       KC_0,        KC_MINS,     KC_EQL,      KC_BSPC,     KC_HOME,     KC_END,
    ...
    [_PROG] = LAYOUT(
        ...
        KC_F1,      KC_F2,      KC_F3,       KC_F4,      KC_NO,      KC_NO,      KC_PERC,    KC_LCBR,    KC_RCBR,           KC_SCLN,    KC_COLN,    KC_NO,      KC_NO,       KC_NO,       KC_NO,       KC_NO,       KC_NO,       KC_PSCR,
        KC_F5,      KC_F6,      KC_F7,       KC_F8,      KC_NO,      KC_NO,      KC_NO,      KC_LPRN,    KC_RPRN,           KC_QUES,    KC_BSLS,    KC_DQUO,    KC_NO,       KC_NO,       KC_7,        KC_8,        KC_9,        KC_PSLS,
        KC_F9,      KC_F10,     KC_F11,      KC_F12,     KC_NO,      KC_NO,      KC_EXLM,    KC_LBRC,    KC_RBRC,           KC_AT,      KC_UNDS,    KC_QUOT,    KC_NO,       KC_NO,       KC_4,        KC_5,        KC_6,        KC_PAST,
        KC_F13,     KC_F14,     KC_F15,      KC_F16,     KC_NO,      KC_NO,      KC_PIPE,    KC_LT,      KC_GT,             KC_HASH,    KC_DLR,     KC_GRV,     KC_NO,       KC_NO,       KC_1,        KC_2,        KC_3,        KC_PMNS,
        KC_F17,     KC_F18,     KC_F19,      KC_F20,     KC_NO,      KC_NO,      KC_TILD,    KC_CIRC,    KC_AMPR,           KC_COMM,    KC_DOT,     KC_NO,      KC_NO,       KC_NO,       KC_0,        KC_DOT,      KC_PEQL,     KC_PPLS
    ),
    [_GAME] = LAYOUT(
        KC_1,           KC_2,           KC_3,           KC_4,           KC_5,           KC_6,           LCTL(KC_1),     LCTL(KC_2),      LCTL(KC_3),            KC_NO,          KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_F24,     TO(_QWERTY),
